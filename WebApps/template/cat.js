...
function init() {
    ...
    const firstModelPath  = './assets/models/cat/CatTexture.glb';
    const secondModelPath = './assets/models/horse/HorseTexture.glb';
    ...
    document.getElementById("pauseAnimation").addEventListener("click", () => {
     ...
     // Initial model load
     loadModel('./assets/models/cat/CatTexture.glb');
